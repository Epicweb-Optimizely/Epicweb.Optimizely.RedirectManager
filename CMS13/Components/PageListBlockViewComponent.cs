using Alloy.Cms13.Business;
using Alloy.Cms13.Models.Blocks;
using Alloy.Cms13.Models.ViewModels;
using EPiServer.Filters;
using EPiServer.Web.Mvc;
using Microsoft.AspNetCore.Mvc;

namespace Alloy.Cms13.Components;
...
public class PageListBlockViewComponent : BlockComponent<PageListBlock>
{
    ...
    private IEnumerable<PageData> FindPages(PageListBlock currentBlock)
    {
        ...
        if (currentBlock.Recursive)
        {
            ...
            {
                pages = _contentLocator.FindPagesByPageType(listRoot as PageReference, true, currentBlock.PageTypeFilter.ID);
            }
            else
            {
